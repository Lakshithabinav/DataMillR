...
public class AuthService {
    ...
    public boolean authenticateUser(String username, String hashedPassword, String ipAddress) {
        ...
        if (authSessionOptional.isPresent()) {
            ...
            Optional<UserInformation> userOptional = userRepository.findByUsername(username);
